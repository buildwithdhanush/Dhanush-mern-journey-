...
console.log(
  `i am ${name},my role is:${objecttype.role},my stack is${objecttype.stack}`,
);
console.log(
  `hi i am ${name} and i am ${age} years old  and i am a${objecttype.role}  and i am learning ${objecttype.stack} stack development`,
);
